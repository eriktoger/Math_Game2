...
* @returns {any}
*/
export function generate_addition(addition) {
    var ret = wasm.generate_addition(addHeapObject(addition));
...
* @returns {any}
*/
export function generate_subtraction(subtraction) {
    var ret = wasm.generate_subtraction(addHeapObject(subtraction));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function generate_multiplication(multiplication) {
    var ret = wasm.generate_multiplication(addHeapObject(multiplication));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function generate_division(division) {
    var ret = wasm.generate_division(addHeapObject(division));
    return takeObject(ret);
}
